...
Exit.BackgroundColor3 = Color3.fromRGB(240, 153, 255)
...
Icon.BackgroundColor3 = Color3.fromRGB(240, 153, 255)
...
Title.BackgroundColor3 = Color3.fromRGB(240, 153, 255)
...
Title.TextColor3 = Color3.fromRGB(240, 153, 255)
...
function init(title, text, closeTime)
	local Notify = Notification:Clone()
	local Sound = Instance.new('Sound', Notification)

	Notify.Visible = true
	Notify.Container.Top.Title.Text = title
	Notify.Container.Body.Content.Text = text

	Notify.Parent = NotificationParent
	Sound.SoundId = "rbxassetid://6518811702"
	Sound:Play()

	T:Create(Notify.Container, t, {Position = UDim2.new(0, 0, 0, 0)}):Play()

	-- auto size
	Notify.AutomaticSize = Enum.AutomaticSize.Y
	Notify.Container.AutomaticSize = Enum.AutomaticSize.Y
	Notify.Container.Body.AutomaticSize = Enum.AutomaticSize.Y
	Notify.Container.Body.Content.AutomaticSize = Enum.AutomaticSize.Y

	Notify.Container.Top.Exit.Button.MouseButton1Click:Connect(function()
		T:Create(Notify.Container, t, {Position = UDim2.new(1.15, 0, 0, 0)}):Play()
		wait(0.48)
		Notify:Destroy()
	end)
...
function notifyLib.init(title, description, closeTime)
	init(title, description, closeTime)
end
