...
function uiLib.CreateWindow(libName, logoId)
    ...
    key1.Text = "LeftAlt"
    key1.TextColor3 = Color3.fromRGB(240, 153, 255)
    ...
    hubLogo.BackgroundColor3 = Color3.fromRGB(240, 153, 255)
    ...
    hubName.TextColor3 = Color3.fromRGB(240, 153, 255)
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        tabBtn.Text = tabText
        tabBtn.TextColor3 = Color3.fromRGB(240, 153, 255)
        ...
        tabLogo.ImageColor3 = Color3.fromRGB(240, 153, 255)
        --
        ...
        function sectionHandling:Section(sectionText)
            ...
            sectionName.TextColor3 = Color3.fromRGB(240, 153, 255)
            ...
            sectionExpannd.ImageColor3 = Color3.fromRGB(240, 153, 255)
            ...
            function ItemHandling:Button(btnText, callback)
                ...
                function ItemHandling:Toggle(toggInfo, callback)
                    ...
                    checkBtn.MouseButton1Click:Connect(function()
                        if not togDe then
                                ...
                                on = not on
                                 callback(on) 
                                if on then
                                    checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(240, 153, 255)
                                    checkBtn.ImageColor3 = Color3.fromRGB(240, 153, 255)
                    ...
                    function ItemHandling:KeyBind(keyInfo, first, callback)
                        ...
                        key.Text = oldKey
                        key.TextColor3 = Color3.fromRGB(240, 153, 255)
                        key.TextSize = 14.000
                        ...
                        function ItemHandling:TextBox(infbix, textPlace, callback)
                            ...
                            TextBox.BackgroundColor3 = Color3.fromRGB(240, 153, 255)
                            ...
                            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                                ...
                                dragSlider.BackgroundColor3 = Color3.fromRGB(240, 153, 255)
                            ...
                            function ItemHandling:Credit(creditWho)
                                ...
                                function ItemHandling:DropDown(dropInfo, list, callback)
                                    ...
                                    expand_more.ImageColor3 = Color3.fromRGB(240, 153, 255)
                                    ...
                                    dropdownItem1.TextColor3 = Color3.fromRGB(240, 153, 255)
